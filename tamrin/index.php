        ...
        <div id="messages" class="flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch">
            ...
            if (isset($allChats)){
                foreach ($allChats as $key => $chat) {
                    if ($chat["username"] == $_SESSION['username']) {
            ...
            ?>
                        <div class="chat-message">
                            <div class="flex items-end justify-end">
                                ...
                                <div class="flex">
                                    <button type="button" class="editMassage inline-flex items-center align-middle justify-center rounded-full h-7 w-7 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none" data-username="<?php echo $chat['username']; ?>" data-id="<?php echo $key; ?>">
                                    ...
                                    <button type="button" class="deleteMassage inline-flex items-center align-middle justify-center rounded-full h-7 w-7 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none" data-username="<?php echo $chat['username']; ?>" data-id="<?php echo $key; ?>">
         ...
         <span class="absolute inset-y-0 flex items-center">
            <button type="button" class="inline-flex items-center justify-center rounded-full h-12 w-12 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none">
               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6 text-gray-600">
                ...
                <?php
                    $projectDirectory=explode('/',$_SERVER['PHP_SELF']);
                    $redirectPath=$_SERVER['HTTP_HOST'].'/'.$projectDirectory[1];
                    /*echo '<pre>';
                    var_dump($_SERVER);
                    echo '</pre>';*/
                ?>
                <input type="hidden" id="rootPath" value="<?php echo $redirectPath; ?>">
                <input type="hidden" id="fullUserData" data-username="<?php echo $_SESSION['username'] ?>" data-privilege="<?php echo $_SESSION['privilege'] ?>" data-fullname="<?php echo $_SESSION['name'] ?>" data-email="<?php echo $_SESSION['email'] ?>">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#imageUpload').on('click', function() {
                ...
                var path="http://"+$('#rootPath').val()+"/doAction.php";
                /*alert(file_data);*/
                $.ajax({
                    url: path,
                    dataType: 'text',
            ...
            setInterval(function () {
                var jsonChatPath="http://"+$('#rootPath').val()+"/chats.json";
                $.ajax({
                    method:"GET",
                    url:jsonChatPath,
                    cache: false,
                    ...
                    success: function (data) {   // success callback function
                        ...
                        $.each(data, function( key, val ) {
                            var currentUsername=$('#fullUserData').attr('data-username');
                            if(currentUsername==val.username)
                            {
                                if(val.textmassage!='' && val.fileurl=='') {
                                    items.push('<div class="chat-message">\n' +
                                        ...
                                        '                                <img src="https://images.unsplash.com/photo-1590031905470-a1a1feacbb0b?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=3&amp;w=144&amp;h=144" alt="My profile" class="w-6 h-6 rounded-full order-2">\n' +
                                        '                                <div class="flex">\n' +
                                        '                                    <button type="button" class="editMassage inline-flex items-center align-middle justify-center rounded-full h-7 w-7 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none" data-username="' + val.username + '" data-id="' + key + '">\n' +
                                        '                                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-pencil-square h-6 w-6 text-gray-600" viewBox="0 0 18 18">\n' +
                                        '                                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>\n' +
                                        '                                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>\n' +
                                        '                                        </svg>\n' +
                                        '                                    </button>\n' +
                                        '                                    <button type="button" class="deleteMassage inline-flex items-center align-middle justify-center rounded-full h-7 w-7 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none" data-username="' + val.username + '" data-id="' + key + '">\n' +
                                        '                                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-trash-fill h-6 w-6 text-gray-600" viewBox="0 0 18 18">\n' +
                                        '                                            <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>\n' +
                                        '                                        </svg>\n' +
                                        '                                    </button>\n' +
                                ...
                                }else
                                {
                                    items.push('<div class="chat-message">\n' +
                                        '                            <div class="flex items-end justify-end">\n' +
                                        '                                <div class="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-1 items-end">\n' +
                                        '                                    <div><img src="'+val.fileurl+'" class="px-4 py-2 rounded-lg inline-block rounded-br-none bg-blue-600 text-white ">' + val.textmassage + '</div>\n' +
                                        '                                </div>\n' +
                                        '                                <img src="https://images.unsplash.com/photo-1590031905470-a1a1feacbb0b?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=3&amp;w=144&amp;h=144" alt="My profile" class="w-6 h-6 rounded-full order-2">\n' +
                                        '                                <div class="flex">\n' +
                                        '                                    <button type="button" class="editMassage inline-flex items-center align-middle justify-center rounded-full h-7 w-7 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none" data-username="' + val.username + '" data-id="' + key + '">\n' +
                                ...
                                }else
                                {
                                    items.push('<div class="chat-message">\n' +
                                        ...
                                        '                                <div class="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-2 items-start">\n' +
                                        '                                    <div>\n' +
                                        '                                        <img src="'+val.fileurl+'" class="px-4 py-2 rounded-lg inline-block rounded-bl-none bg-gray-300 text-gray-600">' + val.textmassage + '\n' +
                                        '                                    </div>\n' +
                                        '                                </div>\n' +
                                        '                                <img src="https://images.unsplash.com/photo-1549078642-b2ba4bda0cdb?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=3&amp;w=144&amp;h=144" alt="My profile" class="w-6 h-6 rounded-full order-1">\n' +
                                        '                                <div class="flex order-2">\n' +
                ...
                /*$.getJSON(jsonChatPath, function( data ) {
                    var items = [];
                    $.each(data, function( key, val ) {
                        var currentUsername=$('#fullUserData').attr('data-username');
                        if(currentUsername==val.username)
                        {
                            items.push( '<div class="chat-message">\n' +
                                ...
                                '                                <img src="https://images.unsplash.com/photo-1590031905470-a1a1feacbb0b?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=3&amp;w=144&amp;h=144" alt="My profile" class="w-6 h-6 rounded-full order-2">\n' +
                                '                                <div class="flex">\n' +
                                '                                    <button type="button" class="editMassage inline-flex items-center align-middle justify-center rounded-full h-7 w-7 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none" data-username="'+val.username+'" data-id="'+val.id+'">\n' +
                                '                                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-pencil-square h-6 w-6 text-gray-600" viewBox="0 0 18 18">\n' +
                                '                                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>\n' +
                                '                                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>\n' +
                                '                                        </svg>\n' +
                                '                                    </button>\n' +
                                '                                    <button type="button" class="deleteMassage inline-flex items-center align-middle justify-center rounded-full h-7 w-7 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none" data-username="'+val.username+'" data-id="'+val.id+'">\n' +
                                '                                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-trash-fill h-6 w-6 text-gray-600" viewBox="0 0 18 18">\n' +
                                '                                            <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>\n' +
                                '                                        </svg>\n' +
                                '                                    </button>\n' +
